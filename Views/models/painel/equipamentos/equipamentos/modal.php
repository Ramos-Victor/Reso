<?php
     include_once $_SERVER['DOCUMENT_ROOT'] . '/Reso/Views/models/painel/salas/salas/function.php';
     include_once $_SERVER['DOCUMENT_ROOT'] . '/Reso/Views/models/painel/categorias/categoria/function.php';
?>
