<?php
     include_once $_SERVER['DOCUMENT_ROOT'] . '/Reso/Views/models/painel/salas/function.php';
     include_once $_SERVER['DOCUMENT_ROOT'] . '/Reso/Views/models/painel/categoria/function.php';
?>
