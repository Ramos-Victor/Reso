...
-- -----------------------------------------------------
-- Schema resol326_resoluton
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema resol326_resoluton
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `resol326_resoluton` DEFAULT CHARACTER SET utf8 ;
USE `resol326_resoluton` ;
-- drop database resol326_resoluton;

-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_usuario` (
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_unidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_unidade` (
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_cargo_unidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_cargo_unidade` (
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_usuario_unidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_usuario_unidade` (
  ...
  CONSTRAINT `fk_tb_usuario_has_tb_unidade_tb_usuario`
    ...
    REFERENCES `resol326_resoluton`.`tb_usuario` (`cd_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_usuario_has_tb_unidade_tb_unidade1`
    FOREIGN KEY (`id_unidade`)
    REFERENCES `resol326_resoluton`.`tb_unidade` (`cd_unidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_usuario_unidade_tb_cargo_unidade1`
    FOREIGN KEY (`id_cargo`)
    REFERENCES `resol326_resoluton`.`tb_cargo_unidade` (`cd_cargo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_st_sala`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_st_sala` (
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_sala`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_sala` (
  `cd_sala` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_tb_sala_tb_usuario_unidade1`
    ...
    REFERENCES `resol326_resoluton`.`tb_usuario_unidade` (`id_usuario` , `id_unidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_sala_tb_st_sala1`
    FOREIGN KEY (`st_sala`)
    REFERENCES `resol326_resoluton`.`tb_st_sala` (`cd_sala`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_equipamento_categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_equipamento_categoria` (
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_st_equipamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_st_equipamento` (
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_equipamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_equipamento` (
  ...
  CONSTRAINT `fk_tb_equipamento_tb_st_equipamento1`
    ...
    REFERENCES `resol326_resoluton`.`tb_st_equipamento` (`cd_st_equipamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_equipamento_tb_equipamento_categoria1`
    FOREIGN KEY (`id_categoria`)
    REFERENCES `resol326_resoluton`.`tb_equipamento_categoria` (`cd_categoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_tb_equipamento_tb_sala1`
    FOREIGN KEY (`id_sala`)
    REFERENCES `resol326_resoluton`.`tb_sala` (`cd_sala`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_st_chamado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_st_chamado` (
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_chamado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_chamado` (
  ...
  CONSTRAINT `fk_tb_chamado_tb_st_chamado1`
    ...
    REFERENCES `resol326_resoluton`.`tb_st_chamado` (`cd_st_chamado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_tb_chamado_tb_usuario_unidade2`
    ...
    REFERENCES `resol326_resoluton`.`tb_usuario_unidade` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_chamado_tb_equipamento1`
    FOREIGN KEY (`id_equipamento`)
    REFERENCES `resol326_resoluton`.`tb_equipamento` (`cd_equipamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_categoria_faq`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_categoria_faq` (
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_faq`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_faq` (
  ...
  CONSTRAINT `fk_tb_faq_tb_categoria_faq1`
    FOREIGN KEY (`id_categoria`)
    REFERENCES `resol326_resoluton`.`tb_categoria_faq` (`cd_categoria_faq`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `resol326_resoluton`.`tb_chat`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resol326_resoluton`.`tb_chat` (
  ...
  CONSTRAINT `fk_tb_chat_tb_chamado1`
    ...
    REFERENCES `resol326_resoluton`.`tb_chamado` (`cd_chamado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
